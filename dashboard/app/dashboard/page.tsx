      ...
      >
        ...
        >
          <div
            ...
            onMouseEnter={(e) => {
              ...
              el.style.boxShadow = "0 8px 16px rgba(59,130,246,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 2px 8px rgba(59,130,246,0.08)";
              el.style.transform = "translateY(0)";
            }}
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>💬</div>
            <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, color: "#1e40af" }}>
              {tr("card_chat_test_title")}
            </h2>
            <p style={{ fontSize: 14, color: "#374151" }}>
              {tr("card_chat_test_desc")}
            </p>
          </div>
        </Link>
        ...
        >
          <div
            ...
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 8px 16px rgba(34,197,94,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
          ...
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>📊</div>
            <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, color: "#15803d" }}>
              {tr("card_analytics_title")}
            </h2>
            <p style={{ fontSize: 14, color: "#374151" }}>
              {tr("card_analytics_desc")}
            </p>
          </div>
        </Link>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 14,
              background: "linear-gradient(135deg, rgba(168,85,247,0.02) 0%, rgba(196,181,253,0.02) 100%)",
              cursor: "pointer",
              transition: "all 0.2s ease",
            ...
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 8px 16px rgba(168,85,247,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 2px 8px rgba(168,85,247,0.08)";
              el.style.transform = "translateY(0)";
            }}
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>⚙️</div>
            <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, color: "#7e22ce" }}>
              {tr("card_settings_title")}
            </h2>
            <p style={{ fontSize: 14, color: "#374151" }}>
              {tr("card_settings_desc")}
            </p>
          </div>
        </Link>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 14,
              background:
                "linear-gradient(135deg, rgba(190,24,93,0.02) 0%, rgba(236,72,153,0.02) 100%)",
              cursor: "pointer",
              transition: "all 0.2s ease",
            ...
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 8px 16px rgba(190,24,93,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 2px 8px rgba(190,24,93,0.08)";
              el.style.transform = "translateY(0)";
            }}
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>🏪</div>
            <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, color: "#9d174d" }}>
              {tr("card_business_title")}
            </h2>
            <p style={{ fontSize: 14, color: "#374151" }}>
              {tr("card_business_desc")}
            </p>
          </div>
        </Link>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 14,
              background:
                "linear-gradient(135deg, rgba(22,163,74,0.02) 0%, rgba(132,204,22,0.02) 100%)",
              cursor: "pointer",
              transition: "all 0.2s ease",
            ...
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 8px 16px rgba(22,163,74,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 2px 8px rgba(22,163,74,0.08)";
              el.style.transform = "translateY(0)";
            }}
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>🧠</div>
            <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, color: "#166534" }}>
              {tr("card_knowledge_title")}
            </h2>
            <p style={{ fontSize: 14, color: "#374151" }}>
              {tr("card_knowledge_desc")}
            </p>
          </div>
        </Link>
        ...
        >
          <div
            ...
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 8px 16px rgba(245,158,11,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 2px 8px rgba(245,158,11,0.08)";
              el.style.transform = "translateY(0)";
            }}
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>📬</div>
            <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, color: "#b45309" }}>
              Inbox
            </h2>
            <p style={{ fontSize: 14, color: "#374151" }}>
              View all customer messages and AI replies.
            </p>
          </div>
        </Link>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 14,
              background:
                "linear-gradient(135deg, rgba(14,116,144,0.02) 0%, rgba(6,182,212,0.02) 100%)",
              cursor: "pointer",
              transition: "all 0.2s ease",
            ...
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 8px 16px rgba(14,116,144,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 2px 8px rgba(14,116,144,0.08)";
              el.style.transform = "translateY(0)";
            }}
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>📅</div>
            ...
            <p style={{ fontSize: 14, color: "#374151" }}>
              View extracted booking intents and captured booking fields.
            </p>
          </div>
        </Link>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 14,
              background:
                "linear-gradient(135deg, rgba(100,116,139,0.02) 0%, rgba(148,163,184,0.02) 100%)",
              cursor: "pointer",
              transition: "all 0.2s ease",
            ...
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 8px 16px rgba(100,116,139,0.15)";
              el.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.boxShadow = "0 2px 8px rgba(100,116,139,0.08)";
              el.style.transform = "translateY(0)";
            }}
          >
            <div style={{ fontSize: 24, marginBottom: 12 }}>🧪</div>
            ...
            <p style={{ fontSize: 14, color: "#374151" }}>
              Simulate WhatsApp inbound messages before Meta is connected.
            </p>
          </div>
        </Link>
      </div>
